class DispatchJob < ActiveRecord::Base
	...
	attribute_order :model_name, :model_id, :locked, :done, :locked_at, :model_description, :model_operation, :retries, :retry_at
	index_order :model_name, :model_id, :locked, :done, :locked_at, :model_operation, :retries
